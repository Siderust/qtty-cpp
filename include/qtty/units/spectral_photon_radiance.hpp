...
template <> struct UnitTraits<PhotonPerSquareMeterSecondSteradianMeterTag> {
  static constexpr UnitId unit_id() { return UNIT_ID_PHOTON_PER_SQUARE_METER_SECOND_STERADIAN_METER; }
...
template <> struct UnitTraits<PhotonPerSquareCentimeterSecondSteradianAngstromTag> {
  static constexpr UnitId unit_id() { return UNIT_ID_PHOTON_PER_SQUARE_CENTIMETER_SECOND_STERADIAN_ANGSTROM; }
...
template <> struct UnitTraits<PhotonPerSquareCentimeterSecondSteradianNanometerTag> {
  static constexpr UnitId unit_id() { return UNIT_ID_PHOTON_PER_SQUARE_CENTIMETER_SECOND_STERADIAN_NANOMETER; }
...
template <> struct UnitTraits<PhotonPerSquareCentimeterNanosecondSteradianNanometerTag> {
  static constexpr UnitId unit_id() { return UNIT_ID_PHOTON_PER_SQUARE_CENTIMETER_NANOSECOND_STERADIAN_NANOMETER; }
